  ...
  return (
    <div className="space-y-5">
      <div className="space-y-1">
        <h2 className="text-[18px] font-extrabold text-slate-900">Résumé des réservations</h2>
      ...
      <div className="space-y-2">
        {multipleBookings.map((booking, idx) => (
          <div
            ...
            className={`relative p-4 rounded-2xl border-2 cursor-pointer transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0 ${
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-center gap-3 flex-1 min-w-0">
                <div className={`w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0 ${
                  booking.service ? 'bg-slate-100' : 'bg-slate-200'
                }`}>
                  {booking.service
      ...
      <div className="space-y-2 pt-2">
        <button
          onClick={onAddPerson}
          className="w-full h-11 rounded-2xl border-2 border-dashed border-slate-300 text-[13px] font-semibold text-slate-500 hover:border-slate-400 hover:text-slate-900 hover:bg-slate-100 transition-all flex items-center justify-center gap-2"
        >
        ...
        <button
          onClick={onFinalize}
          className="w-full h-11 rounded-2xl bg-[#22C55E] hover:bg-[#16A34A] text-white text-[13px] font-bold transition-all shadow-sm shadow-emerald-500/10 active:scale-[0.98]"
        >
